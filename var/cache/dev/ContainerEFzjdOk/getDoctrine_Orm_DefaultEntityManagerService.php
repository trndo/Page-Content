...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\PageContentRepository' => function () {
    return ($this->privates['App\Repository\PageContentRepository'] ?? $this->load('getPageContentRepositoryService.php'));
}))));
