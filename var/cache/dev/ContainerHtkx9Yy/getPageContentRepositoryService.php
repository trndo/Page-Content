...
// Returns the private 'App\Repository\PageContentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PageContentRepository.php';

return $this->privates['App\Repository\PageContentRepository'] = new \App\Repository\PageContentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
